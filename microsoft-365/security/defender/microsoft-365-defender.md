...
- <span data-ttu-id="d01d3-130">Permettre aux équipes de sécurité d’effectuer un recherche de menaces détaillée et efficace sur les données du point de terminaison et d’Office</span><span class="sxs-lookup"><span data-stu-id="d01d3-130">Enable security teams to perform detailed and effective threat hunting across endpoint and Office data</span></span>

<span data-ttu-id="d01d3-131">![Image de la page vue d’ensemble de l’incident](../../media/overview-incident.png)</span><span class="sxs-lookup"><span data-stu-id="d01d3-131">![Image of incident overview page](../../media/overview-incident.png)</span></span> <br>
<span data-ttu-id="d01d3-132">Incident entre produits (vue d’ensemble)</span><span class="sxs-lookup"><span data-stu-id="d01d3-132">Cross-product incident (Overview)</span></span>

<span data-ttu-id="d01d3-133">![Image de la file d’attente des alertes](../../media/incident-list.png)</span><span class="sxs-lookup"><span data-stu-id="d01d3-133">![Image of alerts queue](../../media/incident-list.png)</span></span><br>
<span data-ttu-id="d01d3-134">Toutes les alertes associées dans les produits de suite corrélées en un seul incident (affichage des alertes)</span><span class="sxs-lookup"><span data-stu-id="d01d3-134">All related alerts across the suite products correlated together into a single incident (alerts view)</span></span>

<span data-ttu-id="d01d3-135">![Image de la file d’attente des incidents](../../media/advanced-hunting.png)</span><span class="sxs-lookup"><span data-stu-id="d01d3-135">![Image of incident queue](../../media/advanced-hunting.png)</span></span><br>
