...
- [<span data-ttu-id="f4f28-169">Utiliser des requêtes partagées</span><span class="sxs-lookup"><span data-stu-id="f4f28-169">Use shared queries</span></span>](advanced-hunting-shared-queries.md)
