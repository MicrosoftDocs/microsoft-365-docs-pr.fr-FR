...
1. <span data-ttu-id="62139-116">Sélectionnez **Enregistrer les modifications**.</span><span class="sxs-lookup"><span data-stu-id="62139-116">Select **Save changes**.</span></span>
